...
// const totalMinutes = Number(prompt('Введіть кількість хвилин для форматування'));
...
// function totalNumber(startNumber, maxNumber) {
//     let num = startNumber; // створюємо локальну змінну
